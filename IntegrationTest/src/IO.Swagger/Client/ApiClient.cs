...
namespace IO.Swagger.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://breachedemails.swagger.io/v2");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://breachedemails.swagger.io/v2).
        /// </summary>
        ...
        public ApiClient(String basePath = "http://localhost:50352/v2/")
        {
